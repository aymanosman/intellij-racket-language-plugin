...
public class RacketLangLineImpl extends ASTWrapperPsiElement implements RacketLangLine {

  public RacketLangLineImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull RacketVisitor visitor) {
    visitor.visitLangLine(this);
  }
